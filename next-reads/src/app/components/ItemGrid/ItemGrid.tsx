            ...
            {displayedItems.map((item) => (
              ...
              >
                <div className="flex gap-2 mb-2 justify-center max-w-[180px]">
                  {(itemType === "series" || itemType === "lists") && item.fields.books?.length ? (
...
//       ) : (
//         <>
//           {/* Na mobitelu - 2 kolone, na većim ekranima se uzima `columns` */}
...
//               src={safeImageUrl(b.fields.coverImage?.fields.file.url)}
//               alt={b.fields.title}
//               className="object-cover rounded-md shadow-md w-12 h-16 md:w-20 md:h-28 cursor-pointer hover:opacity-80 transition"
//             />
//           ))
//         ) : (
//           <img
